...
4. If needed, implement Google Mobile Ads iOS SDK, for [GAM](https://developers.google.com/ad-manager/mobile-ads-sdk/ios/quick-start) and/or [GAD](https://developers.google.com/admob/ios/quick-start) in your application.
5. Based on your needs, define custom events using [Header Bidding](https://github.com/pubnative/pubnative-hybid-ios-sdk/wiki/Setup-DFP) and/or [Mediation](https://github.com/pubnative/pubnative-hybid-ios-sdk/wiki/AdMob-Mediation) pages to finish the integration.
6. You’re done.
...
2. If needed, implement Google Mobile Ads iOS SDK, for [GAM](https://developers.google.com/ad-manager/mobile-ads-sdk/ios/quick-start) and/or [GAD](https://developers.google.com/admob/ios/quick-start) in your application.
